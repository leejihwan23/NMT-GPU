...
def preprocess_opts(parser):
    ...
    group.add('--train_src', '-train_src', default=["/home/team012/LJH/NMT-GPU/data/src-train.txt"], nargs='+', #required=True
              help="Path(s) to the training source data")
    group.add('--train_tgt', '-train_tgt', default=["/home/team012/LJH/NMT-GPU/data/tgt-train.txt"],  nargs='+', #required=True,
    ...
    group.add('--valid_src', '-valid_src', default="/home/team012/LJH/NMT-GPU/data/src-val.txt",
              help="Path to the validation source data")
    group.add('--valid_tgt', '-valid_tgt', default="/home/team012/LJH/NMT-GPU/data/tgt-val.txt",
    ...
    group.add('--save_data', '-save_data', default="/home/team012/LJH/NMT-GPU/data/demo",# required=True,
...
def train_opts(parser):
    ...
    group.add('--data', '-data', default="/home/team012/LJH/NMT-GPU/data/demo",#required=True,
    ...
    group.add('--save_model', '-save_model', default='/home/team012/LJH/NMT-GPU/data/model/model',
...
def translate_opts(parser):
    ...
    group.add('--model', '-model', dest='models', metavar='MODEL',
              nargs='+', type=str, default=['/home/team012/LJH/NMT-GPU/data/model/model_step_100.pt'], #required=True,
    ...
    group.add('--src', '-src', default='/home/team012/LJH/NMT-GPU/data/src-test.txt', #required=True,
